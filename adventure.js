function openDoorStep1() {
  ...
  function createDoorStep2() {
    ...
    door.className = "door";
    door.innerHTML = "Click to Enter Treasure Room";
  ...
  function enterFinalRoom() {
    const room = document.querySelector(".room");
    room.innerHTML = "Welcome to the final room. There's a locked treasure chest.";
    createChest();
  }
  ...
  function openChest() {
    ...
    if (hasKey) {
      ...
      chest.innerHTML = "The chest is locked.";
      const room = document.querySelector(".room");
